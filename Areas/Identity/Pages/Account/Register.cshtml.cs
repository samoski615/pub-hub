...
namespace PubHub.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Check the box if you are a bar owner: ")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else if (!Input.IsBarOwner)
                    {
                        await _userManager.AddToRoleAsync(user, StaticDetails.DrinkEnthusiast);
                        return RedirectToAction("Create", "DrinkEnthusiasts");
                    }
